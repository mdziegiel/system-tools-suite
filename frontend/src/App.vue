...
const tools: Tool[] = [
  ...
  { slug:'reverse-dns', title:'Reverse DNS', category:'Network Tools', description:'Resolve PTR records for an IP address.', mode:'backend', fields:[{name:'ip',label:'IP Address',placeholder:'8.8.8.8'}] },
  { slug:'http-headers', title:'HTTP Header Inspector', category:'Network Tools', description:'Fetch URL headers, final URL, and HTTP status.', mode:'backend', fields:[{name:'url',label:'URL',placeholder:'https://example.com'}] },
  { slug:'response-time', title:'Website Response Time', category:'Network Tools', description:'Measure server-side HTTP response time.', mode:'backend', fields:[{name:'url',label:'URL',placeholder:'https://example.com'}] },
  { slug:'nat-translator', title:'Network Address Translator', category:'Network Tools', description:'Translate an address between equal-sized private/public CIDR ranges.', mode:'backend', fields:[{name:'private_cidr',label:'Private CIDR',placeholder:'10.0.0.0/24'},{name:'public_cidr',label:'Public CIDR',placeholder:'203.0.113.0/24'},{name:'address',label:'Private Address',placeholder:'10.0.0.10'}] },
  { slug:'rbl-checker', title:'Blacklist / RBL Checker', category:'Network Tools', description:'Check common DNSBL zones for an IPv4 address.', mode:'backend', fields:[{name:'ip',label:'IP Address',placeholder:'8.8.8.8'}] },
